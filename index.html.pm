...
◊`(div ([class "lg:flex lg:justify-between lg:gap-4"])
  ...
  (main ([class "pt-24 lg:w-1/2 lg:py-24"])
	...
	(footer ([class "max-w-md pb-16 text-sm text-zinc-500 sm:pb-0"])
		(p ([class "mb-1"])
		   "Written in " ,(footer-link "the magnificent wichtel editor" "https://code.visualstudio.com/") " while standing upright thanks to " ,(footer-link "Ben Vallack" "https://www.youtube.com/watch?v=iOupyi-lQZM") ". Built with  " ,(footer-link "Racket" "https://racket-lang.com") ", " ,(footer-link "Pollen" "https://pollenpub.com") " and " ,(footer-link "Tailwind CSS" "https://tailwindcss.com") " on " ,(footer-link "NixOS" "https://nixos.org/") ".")
